# 1 "mcc_generated_files/LINDrivers/lin_slave.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "mcc_generated_files/LINDrivers/lin_slave.c" 2
# 40 "mcc_generated_files/LINDrivers/lin_slave.c"
...
# 40 "mcc_generated_files/LINDrivers/lin_slave.c" 2

# 1 "mcc_generated_files/LINDrivers/../eusart1.h" 1
# 54 "mcc_generated_files/LINDrivers/../eusart1.h"
...
# 54 "mcc_generated_files/LINDrivers/../eusart1.h" 2
...
# 41 "mcc_generated_files/LINDrivers/lin_slave.c" 2
...
# 42 "mcc_generated_files/LINDrivers/lin_slave.c" 2
...
void LIN_queuePacket(uint8_t cmd){
    const lin_rx_cmd_t* tempSchedule = LIN_rxCommand;
    ...
    switch(LIN_rxState){
        ...
        case LIN_RX_PID:
            if(EUSART1_is_rx_ready() > 0){
                ...
                if(LIN_checkPID(LIN_packet.PID) == 0){
                    LIN_rxState = LIN_RX_ERROR;
                    break;
                }
        ...
        case LIN_RX_CHECKSUM:
            ...
            break;
        case LIN_RX_TX_DATA:
            LIN_queuePacket(LIN_packet.PID);
            LIN_rxState = LIN_RX_RDY;
        case LIN_RX_RDY:
            LIN_processData();
        case LIN_RX_ERROR:
...
void LIN_sendPacket(uint8_t length, uint8_t pid, uint8_t* data){
    ...
    EUSART1_Write(LIN_getChecksum(length, pid, data));
}
...
uint8_t LIN_getFromTable(uint8_t cmd, lin_sch_param_t param){
    const lin_rx_cmd_t* rxCommand = LIN_rxCommand;
...
_Bool LIN_breakCheck(void){
    ...
    if((EUSART1_Read() == 0x00) && (EUSART1_get_last_status().ferr == 1)){
        return 1;
    }
